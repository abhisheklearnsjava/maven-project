        ...
        stage ('Deployments'){
            parallel{
                ...
                stage ("Deploy to Production"){
                    steps {
                        bat 'winscp /command "open sftp://ec2-user@18.191.210.153/ -privatekey=D:/mywork/jenkinHandson/puttygen-key.ppk" "put /webapp/target/*.war /var/lib/tomcat7/webapps/" "exit"'
                    }
                }
            }
        }
